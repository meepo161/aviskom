...
class MGR : KSPADTest(view = MGRView::class, reportTemplate = "mgr.xlsx") {
    ...
    private fun startMeasuring() {
        ...
        with(CM.device<CS02021>(PR65)) {
            if (isResponding) {
                setVoltage(testModel.specifiedU_MGR_MPT.toInt())
...
//            }
    ...
    override fun saveProtocol() {
        ...
        reportFields["U_SPEC_MGR_MPT"] = testModel.specifiedData.U.value
        reportFields["R_SPEC_MGR_MPT"] = testModel.specifiedData.R60.value
        reportFields["U_MEAS_MGR_MPT"] = testModel.measuredData.U.value
        reportFields["R15_MEAS_MGR_MPT"] = testModel.measuredData.R15.value
        reportFields["R60_MEAS_MGR_MPT"] = testModel.measuredData.R60.value
        reportFields["K_ABS_MEAS_MGR_MPT"] = testModel.measuredData.K_ABS.value
        reportFields["TEMP_AMB_MGR_MPT"] = testModel.measuredData.tempAmb.value
        reportFields["TEMP_TI_MGR_MPT"] = testModel.measuredData.tempTI.value
        reportFields["RESULT_MGR_MPT"] = testModel.measuredData.result.value
